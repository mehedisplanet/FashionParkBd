"""
Django settings for FashionPark project.
...
ALLOWED_HOSTS = ["*"]
CSRF_TRUSTED_ORIGINS=['https://fashionparkbd.onrender.com','https://*.127.0.0.1']
...
WSGI_APPLICATION = 'FashionPark.wsgi.application'
